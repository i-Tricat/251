...
if("TRUE" STREQUAL "TRUE")
  set(ublox_gps_SOURCE_PREFIX /home/i-tricat241/catkin_ws/src/ublox/ublox_gps)
...
if(NOT "/home/i-tricat241/catkin_ws/src/ublox/ublox_gps/include " STREQUAL " ")
  set(ublox_gps_INCLUDE_DIRS "")
  set(_include_dirs "/home/i-tricat241/catkin_ws/src/ublox/ublox_gps/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ublox_gps' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/i-tricat241/catkin_ws/src/ublox/ublox_gps/${idir}'.  ${_report}")
    endif()
